...
@section('title', 'Register form form')
...
<div class="container">
    ...
    <form action="{{ route('store') }}" method="post">
        ...
        <div class="input-field">
            ...
            @endif
            <span class="show toggle-password" data-target="#password">SHOW</span>
            <label>Password</label>
        </div>
        <div class="input-field">
            <input type="password" class="pswrd" id="password_confirmation" name="password_confirmation">
            <span class="show toggle-password" data-target="#password_confirmation">SHOW</span>
